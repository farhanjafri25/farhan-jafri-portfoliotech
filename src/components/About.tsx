    ...
    <section id="about" className="py-20 bg-gradient-secondary">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-serif font-normal italic mb-4">About Me</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {highlights.map((item, index) => (
            <Card key={index} className="bg-card border-border shadow-card hover:-translate-y-1 hover:shadow-md transition-all duration-300 hover:scale-[1.01]">
        ...
        <Card className="bg-card border-border shadow-card">
          <CardContent className="p-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-2xl font-serif font-normal italic mb-4">My Journey</h3>
                ...
                <Badge variant="outline" className="bg-background border-border text-foreground/80 mb-2 mr-2">B.Tech Electronics & Communication</Badge>
                <Badge variant="outline" className="bg-background border-border text-foreground/80 mb-2">CGPA: 9.1</Badge>
              </div>
